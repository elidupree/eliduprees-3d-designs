...
def funnel_shape(start, dir, offset):
    tube_hoops = [Wire(Circle(Axes(start+dir*dist, dir), tube_od+offset+flare)) for dist, flare in [(-6,1), (-3,-0.5), (0,-0.5), (3,0), (6,0), (9,0), (12,0), (15,1)]]
...
def glove_drier():
    ...
    tube_stuff = [(Origin + dir*25 + Up*40, Direction(Up*1 + dir*0.4)) for dir in directions]
...
def save():
    ...
    export("glove_drier.stl", "glove_drier_1.stl")